...
import Gestiones.GestionCategoria;
...
DefaultTableModel dta;
    ...
    private void btnInserActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInserActionPerformed
        categoria.getCategoria().setCodigoCategoria(Integer.parseInt(txtId.getText()));
        categoria.getCategoria().setNombreCategoria(txtNombre.getText());
        categoria.getCategoria().setDescripcionCategoria(txtDesc.getText());
...
//        usuario.getUsuario().setId(txtId.getText());
        ...
        try
        {
            ...
            txtId.setText(Integer.toString(categoria.getCategoria().getCodigoCategoria()));
            txtNombre.setText(categoria.getCategoria().getNombreCategoria());
            txtDesc.setText(categoria.getCategoria().getDescripcionCategoria());
...
//      Tabla_datos.setModel(new DefaultTableModel());
    ...
    private void jbtconsultaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtconsultaActionPerformed
        ...
        try {
        this.Tabla_datos.setModel(categoria.cargarTabla());
    } catch (SQLException ex) {
            JOptionPane.showMessageDialog(this, ex.getMessage());
        }
